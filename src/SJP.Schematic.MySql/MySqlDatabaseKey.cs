...
/// <summary>
/// A database key implementation, specific to MySQL.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MySqlDatabaseKey"/> class.
    /// </summary>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="name"/> or <paramref name="columns"/> is <see langword="null" />, or <paramref name="columns"/> contains <see langword="null" /> values.</exception>
    /// <exception cref="ArgumentException"><paramref name="columns"/> is empty, or <paramref name="keyType"/> is not a valid enum.</exception>
    public MySqlDatabaseKey(Identifier name, DatabaseKeyType keyType, IReadOnlyCollection<IDatabaseColumn> columns, Option<IDatabaseIndex> backingIndex)
    {
    ...
    /// <summary>
    /// The name of the key constraint. For primary keys this is always <c>PRIMARY</c>.
    /// </summary>
