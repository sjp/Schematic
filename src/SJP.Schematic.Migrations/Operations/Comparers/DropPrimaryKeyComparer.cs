...
{
    public class DropPrimaryKeyComparer : EqualityComparer<DropPrimaryKeyOperation>
    {
        public override bool Equals(DropPrimaryKeyOperation x, DropPrimaryKeyOperation y)
        {
        ...
        public override int GetHashCode(DropPrimaryKeyOperation obj)
        {
            if (obj == null)
