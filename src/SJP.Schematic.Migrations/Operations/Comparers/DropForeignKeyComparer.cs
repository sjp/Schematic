...
{
    public class DropForeignKeyComparer : EqualityComparer<DropForeignKeyOperation>
    {
        public override bool Equals(DropForeignKeyOperation x, DropForeignKeyOperation y)
        {
        ...
        public override int GetHashCode(DropForeignKeyOperation obj)
        {
            if (obj == null)
