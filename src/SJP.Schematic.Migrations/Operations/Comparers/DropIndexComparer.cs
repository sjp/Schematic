...
{
    public class DropIndexComparer : EqualityComparer<DropIndexOperation>
    {
        public override bool Equals(DropIndexOperation x, DropIndexOperation y)
        {
        ...
        public override int GetHashCode(DropIndexOperation obj)
        {
            if (obj == null)
