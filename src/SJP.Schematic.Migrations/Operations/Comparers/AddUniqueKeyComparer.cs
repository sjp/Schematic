...
{
    public class AddUniqueKeyComparer : EqualityComparer<AddUniqueKeyOperation>
    {
        public override bool Equals(AddUniqueKeyOperation x, AddUniqueKeyOperation y)
        {
        ...
        public override int GetHashCode(AddUniqueKeyOperation obj)
        {
            if (obj == null)
