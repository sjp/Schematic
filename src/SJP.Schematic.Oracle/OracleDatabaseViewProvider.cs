...
public class OracleDatabaseViewProvider : IDatabaseViewProvider
{
    ...
    public OracleDatabaseViewProvider(ISchematicConnection connection, IIdentifierDefaults identifierDefaults, IIdentifierResolutionStrategy identifierResolver)
    {
        ...
        _queryViewProvider = new OracleDatabaseQueryViewProvider(connection, identifierDefaults, identifierResolver);
        _materializedViewProvider = new OracleDatabaseMaterializedViewProvider(connection, identifierDefaults, identifierResolver);
    ...
    private readonly OracleDatabaseQueryViewProvider _queryViewProvider;
    private readonly OracleDatabaseMaterializedViewProvider _materializedViewProvider;
}