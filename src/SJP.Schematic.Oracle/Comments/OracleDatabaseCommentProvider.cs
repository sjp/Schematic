...
public class OracleDatabaseCommentProvider : IRelationalDatabaseCommentProvider
{
    ...
    /// <summary>
    /// Enumerates all database user-defined type comments defined within a database. Oracle records
    /// no comments on a type, so this will always be an empty collection.
    /// </summary>
    /// <param name="cancellationToken">The cancellation token.</param>
    ...
    /// <summary>
    /// Retrieves all database user-defined type comments defined within a database. Oracle records
    /// no comments on a type, so this will always be an empty collection.
    /// </summary>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>An empty collection of user-defined type comments.</returns>
    ...
    /// <summary>
    /// Retrieves comments for a particular database user-defined type. Oracle records no comments
    /// on a type, so this will always be a 'none' result.
    /// </summary>
