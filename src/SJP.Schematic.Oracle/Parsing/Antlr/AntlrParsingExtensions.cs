...
/// <summary>
/// Helper routines shared by the ANTLR-based Oracle parsing consumers.
/// </summary>
internal static class AntlrParsingExtensions
{
    /// <summary>
    /// Determines whether a token may be used as an identifier in Oracle, i.e. it is a regular
    /// identifier, a delimited (double-quoted) identifier, or a non-reserved keyword.
    /// </summary>
    ...
    public static bool IsIdentifier(IToken token)
    {
        ...
        return PlSqlIdentifierTokens.Types.Contains(token.Type);
    }

    /// <summary>
    /// Removes the surrounding delimiters from a delimited (double-quoted) identifier, unescaping any
    /// doubled quotes. Non-delimited identifiers are returned unchanged.
    /// </summary>
