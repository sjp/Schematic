...
namespace SJP.Schematic.Oracle
{
    ...
    {
        public OracleDatabaseSynonymProvider(IDbConnection connection, IDatabaseIdentifierDefaults identifierDefaults, IIdentifierResolutionStrategy identifierResolver)
        {
