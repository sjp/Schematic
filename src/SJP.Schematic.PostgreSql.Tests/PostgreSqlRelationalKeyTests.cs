...
{
    [TestFixture]
    internal static class PostgreSqlRelationalKeyTests
    {
        [Test]
        public static void Ctor_GivenNullChildTable_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlRelationalKey(null, childKey, parentTableName, parentKey, deleteRule, updateRule));
        }
        ...
        public static void Ctor_GivenNullChildKey_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlRelationalKey(childTableName, null, parentTableName, parentKey, deleteRule, updateRule));
        }
        ...
        public static void Ctor_GivenNullParentTable_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlRelationalKey(childTableName, childKey, null, parentKey, deleteRule, updateRule));
        }
        ...
        public static void Ctor_GivenNullParentKey_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlRelationalKey(childTableName, childKey, parentTableName, null, deleteRule, updateRule));
        }
        ...
        public static void Ctor_GivenInvalidDeleteRule_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => new PostgreSqlRelationalKey(childTableName, childKey, parentTableName, parentKey, deleteRule, updateRule));
        }
        ...
        public static void ChildTable_PropertyGet_MatchesCtorArg()
        {
            ...
            var relationalKey = new PostgreSqlRelationalKey(childTableName, childKey, parentTableName, parentKey, deleteRule, updateRule);
        ...
        public static void Ctor_GivenChildKeyNotForeignKey_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => new PostgreSqlRelationalKey(childTableName, childKeyMock.Object, parentTableName, parentKeyMock.Object, deleteRule, updateRule));
        }
