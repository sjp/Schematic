...
using TableProvider = SJP.Schematic.PostgreSql.Versions.V12.PostgreSqlRelationalDatabaseTableProvider;

namespace SJP.Schematic.PostgreSql.Tests.Versions.V12;
