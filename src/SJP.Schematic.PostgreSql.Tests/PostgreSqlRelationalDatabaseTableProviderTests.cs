...
internal static class PostgreSqlRelationalDatabaseTableProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlRelationalDatabaseTableProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlRelationalDatabaseTableProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlRelationalDatabaseTableProvider(connection, identifierDefaults, null),
