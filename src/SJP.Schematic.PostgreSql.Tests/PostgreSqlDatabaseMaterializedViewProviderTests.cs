...
internal static class PostgreSqlDatabaseMaterializedViewProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseMaterializedViewProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseMaterializedViewProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseMaterializedViewProvider(connection, identifierDefaults, null),
