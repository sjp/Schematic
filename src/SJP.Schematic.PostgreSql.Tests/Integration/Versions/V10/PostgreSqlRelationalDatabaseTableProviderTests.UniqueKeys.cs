...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V10
{
    internal partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql10Test
    {
        ...
        {
            var table = await GetTableAsync("v10_table_test_table_5").ConfigureAwait(false);
        ...
        {
            var table = await GetTableAsync("v10_table_test_table_6").ConfigureAwait(false);
            var uk = table.UniqueKeys.Single();
        ...
        public async Task UniqueKeys_WhenGivenTableWithMultiColumnConstraintAsUniqueKey_ReturnsUniqueKeyWithColumnsInCorrectOrder()
        {
            ...
            var table = await GetTableAsync("v10_table_test_table_7").ConfigureAwait(false);
            var uk = table.UniqueKeys.Single();
