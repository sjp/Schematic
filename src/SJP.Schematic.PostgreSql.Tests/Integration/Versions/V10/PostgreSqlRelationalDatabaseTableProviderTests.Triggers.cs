...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V10
{
    internal sealed partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql10Test
    {
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_2").ConfigureAwait(false);
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
        ...
        {
            Identifier triggerName = "v10_trigger_test_table_1_trigger_1";
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_1");

            const string expectedDefinition = "EXECUTE PROCEDURE v10_test_trigger_fn()";
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_2");
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_3");
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_4");
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_5");
        ...
        {
            var table = await GetTableAsync("v10_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v10_trigger_test_table_1_trigger_6");
