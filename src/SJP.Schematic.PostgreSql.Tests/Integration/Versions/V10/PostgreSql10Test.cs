...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V10
{
    ...
    internal abstract class PostgreSql10Test
    {
        ...
        protected IIdentifierDefaults IdentifierDefaults { get; } = Config10.SchematicConnection.Dialect.GetIdentifierDefaultsAsync(Config10.SchematicConnection).GetAwaiter().GetResult();
