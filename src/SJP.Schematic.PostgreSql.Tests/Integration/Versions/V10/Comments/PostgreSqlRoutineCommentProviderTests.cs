...
LANGUAGE PLPGSQL").ConfigureAwait(false);
        ...
        {
            await Connection.ExecuteAsync("drop function v10_comment_test_routine_1").ConfigureAwait(false);
            await Connection.ExecuteAsync("drop function v10_comment_test_routine_2").ConfigureAwait(false);
        }
