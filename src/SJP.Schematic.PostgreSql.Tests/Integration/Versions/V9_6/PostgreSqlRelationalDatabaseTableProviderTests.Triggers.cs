...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V9_6
{
    internal partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql96Test
    {
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_2").ConfigureAwait(false);
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var count = table.Triggers.Count;
        ...
        {
            Identifier triggerName = "v96_trigger_test_table_1_trigger_1";
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_1");

            const string expectedDefinition = "EXECUTE PROCEDURE v96_test_trigger_fn()";
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_2");
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_3");
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_4");
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_5");
        ...
        {
            var table = await GetTableAsync("v96_trigger_test_table_1").ConfigureAwait(false);
            var trigger = table.Triggers.First(t => t.Name == "v96_trigger_test_table_1_trigger_6");
