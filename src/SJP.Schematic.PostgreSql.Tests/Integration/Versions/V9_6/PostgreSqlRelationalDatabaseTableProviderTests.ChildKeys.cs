...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V9_6
{
    internal sealed partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql96Test
    {
        ...
        {
            var table = await GetTableAsync("v96_table_test_table_2").ConfigureAwait(false);
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKey_ContainsConstraintWithCorrectNames()
        {
            ...
            var foreignKey = table.ChildKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_16", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKey_ContainsConstraintWithCorrectTables()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(foreignKey.ChildTable.LocalName, Is.EqualTo("v96_table_test_table_16"));
                Assert.That(foreignKey.ParentTable.LocalName, Is.EqualTo("v96_table_test_table_15"));
            });
        }
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithDefaultUpdateAction_ReturnsUpdateActionAsNoAction()
        {
            ...
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_16", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithCascadeUpdateAction_ReturnsUpdateActionAsCascade()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_18", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithSetNullUpdateAction_ReturnsUpdateActionAsSetNull()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_19", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithSetDefaultUpdateAction_ReturnsUpdateActionAsSetDefault()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_20", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithCascadeDeleteAction_ReturnsDeleteActionAsCascade()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_24", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithSetNullDeleteAction_ReturnsDeleteActionAsSetNull()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_25", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToPrimaryKeyWithSetDefaultDeleteAction_ReturnsDeleteActionAsSetDefault()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_26", System.StringComparison.Ordinal));
        ...
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var foreignKey = table.ChildKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_17", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKey_ContainsConstraintWithCorrectTables()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(foreignKey.ChildTable.LocalName, Is.EqualTo("v96_table_test_table_17"));
                Assert.That(foreignKey.ParentTable.LocalName, Is.EqualTo("v96_table_test_table_15"));
            });
        }
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithDefaultUpdateAction_ReturnsUpdateActionAsNoAction()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_17", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithCascadeUpdateAction_ReturnsUpdateActionAsCascade()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_21", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithSetNullUpdateAction_ReturnsUpdateActionAsSetNull()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_22", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithSetDefaultUpdateAction_ReturnsUpdateActionAsSetDefault()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_23", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithCascadeDeleteAction_ReturnsDeleteActionAsCascade()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_27", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithSetNullDeleteAction_ReturnsDeleteActionAsSetNull()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_28", System.StringComparison.Ordinal));
        ...
        public async Task ChildKeys_WhenGivenChildTableWithForeignKeyToUniqueKeyWithSetDefaultDeleteAction_ReturnsDeleteActionAsSetDefault()
        {
            var table = await GetTableAsync("v96_table_test_table_15").ConfigureAwait(false);
            var childKeys = table.ChildKeys;
            var foreignKey = childKeys.Single(k => string.Equals(k.ChildTable.LocalName, "v96_table_test_table_29", System.StringComparison.Ordinal));
