...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V13
{
    internal sealed partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql13Test
    {
        ...
        {
            var table = await GetTableAsync("v13_table_test_table_5").ConfigureAwait(false);
        ...
        {
            var table = await GetTableAsync("v13_table_test_table_6").ConfigureAwait(false);
            var uk = table.UniqueKeys.Single();
        ...
        public async Task UniqueKeys_WhenGivenTableWithMultiColumnConstraintAsUniqueKey_ReturnsUniqueKeyWithColumnsInCorrectOrder()
        {
            ...
            var table = await GetTableAsync("v13_table_test_table_7").ConfigureAwait(false);
            var uk = table.UniqueKeys.Single();
