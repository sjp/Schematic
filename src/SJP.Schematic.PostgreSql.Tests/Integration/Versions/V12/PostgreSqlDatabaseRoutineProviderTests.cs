...
{
    internal sealed class PostgreSqlDatabaseRoutineProviderTests : PostgreSql12Test
    {
        ...
        {
            // func
            await DbConnection.ExecuteAsync(@"CREATE FUNCTION v12_db_test_routine_1(val integer)
RETURNS integer AS $$
BEGIN
    RETURN val + 1;
END; $$
LANGUAGE PLPGSQL", CancellationToken.None).ConfigureAwait(false);
            // stored proc
            await DbConnection.ExecuteAsync(@"CREATE PROCEDURE v12_db_test_routine_2()
LANGUAGE PLPGSQL
AS $$
BEGIN
    COMMIT;
END $$", CancellationToken.None).ConfigureAwait(false);
        ...
        {
            await DbConnection.ExecuteAsync("drop function v12_db_test_routine_1(integer)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop procedure v12_db_test_routine_2()", CancellationToken.None).ConfigureAwait(false);
        }
        ...
        {
            var routineIsSome = await RoutineProvider.GetRoutine("v12_db_test_routine_1").IsSome.ConfigureAwait(false);
        ...
        {
            const string routineName = "v12_db_test_routine_1";
        ...
        {
            var routineName = new Identifier("v12_db_test_routine_1");
            var expectedRoutineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        {
            var routineName = new Identifier(IdentifierDefaults.Schema, "v12_db_test_routine_1");
            var expectedRoutineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        {
            var routineName = new Identifier(IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
            var expectedRoutineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        {
            var routineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        {
            var routineName = new Identifier("A", IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
            var expectedRoutineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        {
            var routineName = new Identifier("A", "B", IdentifierDefaults.Schema, "v12_db_test_routine_1");
            var expectedRoutineName = new Identifier(IdentifierDefaults.Server, IdentifierDefaults.Database, IdentifierDefaults.Schema, "v12_db_test_routine_1");
        ...
        public async Task GetAllRoutines_WhenEnumerated_ContainsTestRoutine()
        {
            var containsTestRoutine = await RoutineProvider.GetAllRoutines()
                .AnyAsync(r => string.Equals(r.Name.LocalName, "v12_db_test_routine_1", StringComparison.Ordinal))
                .ConfigureAwait(false);
        ...
        {
            var routine = await GetRoutineAsync("v12_db_test_routine_1").ConfigureAwait(false);
...
END; ";
        ...
        {
            var routine = await GetRoutineAsync("v12_db_test_routine_2").ConfigureAwait(false);
