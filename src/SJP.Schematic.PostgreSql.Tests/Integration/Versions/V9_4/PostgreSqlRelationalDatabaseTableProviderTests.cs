...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V9_4
{
    internal partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql94Test
    {
        ...
        {
            await DbConnection.ExecuteAsync("create table v94_db_test_table_1 ( title varchar(200) )", CancellationToken.None).ConfigureAwait(false);

            await DbConnection.ExecuteAsync("create table v94_table_test_table_1 ( test_column int )", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("create table v94_table_test_table_2 ( test_column int not null primary key )", CancellationToken.None).ConfigureAwait(false);
...
create table v94_table_test_table_4 (
    ...
    constraint pk_test_table_4 primary key (first_name, last_name, middle_name)
            ...
            await DbConnection.ExecuteAsync("create table v94_table_test_table_5 ( test_column int not null unique )", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
...
create table v94_table_test_table_8 (
    test_column int
            ...
            await DbConnection.ExecuteAsync("create index ix_test_table_8 on v94_table_test_table_8 (test_column)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
create table v94_table_test_table_9 (
    ...
    last_name varchar(50)
            ...
            await DbConnection.ExecuteAsync("create index ix_test_table_9 on v94_table_test_table_9 (first_name, last_name, middle_name)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
create table v94_table_test_table_10 (
    test_column int,
    test_column_2 int
)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("create index ix_test_table_10 on v94_table_test_table_10 (test_column)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
create table v94_table_test_table_11 (
    ...
    last_name varchar(50)
            ...
            await DbConnection.ExecuteAsync("create index ix_test_table_11 on v94_table_test_table_11 (first_name)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
create table v94_table_test_table_12 (
    ...
    last_name varchar(50)
            ...
            await DbConnection.ExecuteAsync("create index ix_test_table_12 on v94_table_test_table_12 (first_name)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
create table v94_table_test_table_13 (
    ...
    last_name varchar(50)
            ...
            await DbConnection.ExecuteAsync("create unique index ix_test_table_13 on v94_table_test_table_13 (first_name, last_name, middle_name)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
...
create table v94_table_test_table_32 (
    ...
    constraint ck_test_table_32 check (test_column > 1)
            ...
            await DbConnection.ExecuteAsync("create table v94_table_test_table_33 ( test_column int not null default 1 )", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("create table v94_table_test_table_35 ( test_column serial primary key )", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("create table v94_trigger_test_table_1 (table_id int primary key not null)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("create table v94_trigger_test_table_2 (table_id int primary key not null)", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"create function v94_test_trigger_fn()
returns trigger as
$BODY$
BEGIN
    RETURN null;
...
execute procedure v94_test_trigger_fn()", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync(@"
...
execute procedure v94_test_trigger_fn()", CancellationToken.None).ConfigureAwait(false);
        ...
        {
            await DbConnection.ExecuteAsync("drop table v94_db_test_table_1", CancellationToken.None).ConfigureAwait(false);

            await DbConnection.ExecuteAsync("drop table v94_table_test_table_1", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_2", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_3", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_4", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_5", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_6", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_7", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_8", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_9", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_10", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_11", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_12", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_13", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_14", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_16", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_17", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_18", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_19", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_20", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_21", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_22", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_23", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_24", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_25", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_26", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_27", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_28", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_29", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_30", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_31", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_15", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_32", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_33", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_table_test_table_35", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_trigger_test_table_1", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop table v94_trigger_test_table_2", CancellationToken.None).ConfigureAwait(false);
            await DbConnection.ExecuteAsync("drop function v94_test_trigger_fn()", CancellationToken.None).ConfigureAwait(false);
        }
