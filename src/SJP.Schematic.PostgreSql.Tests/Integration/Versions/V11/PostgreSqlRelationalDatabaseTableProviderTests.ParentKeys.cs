...
namespace SJP.Schematic.PostgreSql.Tests.Integration.Versions.V11
{
    internal partial class PostgreSqlRelationalDatabaseTableProviderTests : PostgreSql11Test
    {
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_18").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_19").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_20").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_24").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_25").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_26").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_17").ConfigureAwait(false);
            var foreignKey = table.ParentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_21").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_22").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_23").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_27").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_28").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
        ...
        {
            var table = await GetTableAsync("v11_table_test_table_29").ConfigureAwait(false);
            var parentKeys = table.ParentKeys;
            var foreignKey = parentKeys.Single();
