...
namespace SJP.Schematic.PostgreSql.Tests
{
    ...
    internal static class PostgreSqlDialectTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => PostgreSqlDialect.CreateConnectionAsync(null));
        }

        [Test]
        public static void CreateConnectionAsync_GivenEmptyString_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => PostgreSqlDialect.CreateConnectionAsync(string.Empty));
        }

        [Test]
        public static void CreateConnectionAsync_GivenWhiteSpaceString_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => PostgreSqlDialect.CreateConnectionAsync("   "));
        }
