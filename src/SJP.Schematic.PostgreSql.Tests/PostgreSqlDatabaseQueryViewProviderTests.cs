...
internal static class PostgreSqlDatabaseQueryViewProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseQueryViewProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseQueryViewProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new PostgreSqlDatabaseQueryViewProvider(connection, identifierDefaults, null),
