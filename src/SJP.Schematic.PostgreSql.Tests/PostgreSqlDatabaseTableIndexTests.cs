...
{
    [TestFixture]
    internal static class PostgreSqlDatabaseTableIndexTests
    {
        [Test]
        public static void Ctor_GivenNullTable_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlDatabaseTableIndex(null, indexName, isUnique, columns));
        }
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlDatabaseTableIndex(table, null, isUnique, columns));
        }
        ...
        public static void Ctor_GivenNullColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlDatabaseTableIndex(table, indexName, isUnique, null));
        }
        ...
        public static void Ctor_GivenEmptyColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PostgreSqlDatabaseTableIndex(table, indexName, isUnique, columns));
        }
        ...
        public static void Table_PropertyGet_EqualsCtorArg()
        {
            ...
            var index = new PostgreSqlDatabaseTableIndex(table, indexName, isUnique, columns);
