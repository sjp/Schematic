...
internal static class PocoTableGeneratorTests
{
    ...
    {
        Assert.That(
            () => new PocoTableGenerator(null, new VerbatimNameTranslator(), "test"),
    ...
    {
        Assert.That(
            () => new PocoTableGenerator(new MockFileSystem(), null, "test"),
    ...
    public static void Ctor_GivenNullOrWhiteSpaceNamespace_ThrowsArgumentException(string ns)
    {
        ...
        Assert.That(
            () => new PocoTableGenerator(fileSystem, nameTranslator, ns),
