...
internal static class ColumnWithNullDefaultValueRuleTests
{
    ...
    public static void Ctor_GivenInvalidLevel_ThrowsArgumentException()
    {
        ...
        Assert.That(() => new ColumnWithNullDefaultValueRule(level), Throws.ArgumentException);
    }
    ...
    [Test]
    public static async Task AnalyseTables_GivenTableWithColumnsContainingDefaultValues_ProducesMessageWithVisibleTableName()
    {
        var rule = new ColumnWithNullDefaultValueRule(RuleLevel.Error);
