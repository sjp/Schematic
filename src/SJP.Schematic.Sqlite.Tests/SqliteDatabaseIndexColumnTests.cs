...
namespace SJP.Schematic.Sqlite.Tests
{
    ...
    internal static class SqliteDatabaseIndexColumnTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new SqliteDatabaseIndexColumn((IDatabaseColumn)null, IndexColumnOrder.Ascending));
        }
        ...
        public static void Ctor_GivenInvalidColumnOrder_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => new SqliteDatabaseIndexColumn(column, order));
        }
        ...
        {
            var column = Mock.Of<IDatabaseColumn>();
            var indexColumn = new SqliteDatabaseIndexColumn(column, IndexColumnOrder.Ascending);
        ...
        {
            var column = Mock.Of<IDatabaseColumn>();
            var indexColumn = new SqliteDatabaseIndexColumn(column, IndexColumnOrder.Descending);
