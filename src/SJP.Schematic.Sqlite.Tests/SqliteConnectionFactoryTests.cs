...
internal static class SqliteConnectionFactoryTests
{
    ...
    {
        Assert.That(() => new SqliteConnectionFactory(connectionString), Throws.InstanceOf<ArgumentException>().With.Property(nameof(ArgumentException.ParamName)).EqualTo("connectionString"));
    }
