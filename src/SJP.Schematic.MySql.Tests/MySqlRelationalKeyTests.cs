...
{
    [TestFixture]
    internal class MySqlRelationalKeyTests
    {
        [Test]
        ...
        [Test]
        public void Ctor_GivenSetDefaultUpdateRule_ThrowsArgumentException()
        {
            var childKey = Mock.Of<IDatabaseKey>();
            var parentKey = Mock.Of<IDatabaseKey>();
            const Rule deleteRule = Rule.None;
        ...
        [Test]
        public void Ctor_GivenSetDefaultDeleteRule_ThrowsArgumentException()
        {
            var childKey = Mock.Of<IDatabaseKey>();
            var parentKey = Mock.Of<IDatabaseKey>();
