...
{
    [TestFixture]
    internal static class MySqlDatabaseComputedTableColumnTests
    {
        [Test]
        public static void Ctor_GivenNullTable_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedTableColumn(null, "test_column", columnType, true, null, definition));
        }
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedTableColumn(table, null, columnType, true, null, definition));
        }
        ...
        public static void Ctor_GivenNullType_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedTableColumn(table, "test_column", null, true, null, definition));
        }
        ...
        public static void Ctor_GivenNullDefinition_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedTableColumn(table, "test_column", null, true, null, null));
        }
        ...
        public static void Table_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseComputedTableColumn(tableArg, "test_column", columnType, true, null, definition);
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            const string definition = "test";
            var column = new MySqlDatabaseComputedTableColumn(table, columnName, columnType, true, null, definition);
        ...
        public static void IsNullable_GivenFalseCtorArgPropertyGet_EqualsFalse()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            const string definition = "test";
            var column = new MySqlDatabaseComputedTableColumn(table, columnName, columnType, false, null, definition);
        ...
        public static void DefaultValue_PropertyGet_ReturnsCtorArg()
        {
            ...
            const string definition = "test";
            var column = new MySqlDatabaseComputedTableColumn(table, columnName, columnType, true, defaultValue, definition);
