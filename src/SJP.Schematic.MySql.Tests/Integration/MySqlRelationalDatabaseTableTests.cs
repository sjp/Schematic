...
").ConfigureAwait(false);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new MySqlRelationalDatabaseTable(null, Database, "test"));
        }

        [Test]
        public void Ctor_GivenNullDatabase_ThrowsArgNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new MySqlRelationalDatabaseTable(Connection, null, "test"));
        }

        [Test]
        public void Ctor_GivenNullName_ThrowsArgNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new MySqlRelationalDatabaseTable(Connection, Database, null));
        }
        ...
        public void Name_PropertyGet_ShouldEqualCtorArg()
        {
            ...
            var table = new MySqlRelationalDatabaseTable(Connection, Database, tableName);
