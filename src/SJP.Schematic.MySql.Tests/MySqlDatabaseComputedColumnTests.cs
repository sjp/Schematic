...
{
    [TestFixture]
    internal static class MySqlDatabaseComputedColumnTests
    {
        [Test]
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedColumn(null, columnType, true, null, definition));
        }
        ...
        public static void Ctor_GivenNullType_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedColumn("test_column", null, true, null, definition));
        }

        [Test]
        public static void Ctor_GivenNullDefinition_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseComputedColumn("test_column", null, true, null, null));
        }
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            const string definition = "test";
            var column = new MySqlDatabaseComputedColumn(columnName, columnType, true, null, definition);
        ...
        public static void IsNullable_GivenFalseCtorArgPropertyGet_EqualsFalse()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            const string definition = "test";
            var column = new MySqlDatabaseComputedColumn(columnName, columnType, false, null, definition);
        ...
        public static void DefaultValue_PropertyGet_ReturnsCtorArg()
        {
            ...
            const string definition = "test";
            var column = new MySqlDatabaseComputedColumn(columnName, columnType, true, defaultValue, definition);
