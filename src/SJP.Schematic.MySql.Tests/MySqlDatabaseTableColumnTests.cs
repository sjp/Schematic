...
{
    [TestFixture]
    internal static class MySqlDatabaseTableColumnTests
    {
        [Test]
        public static void Ctor_GivenNullTable_ThrowsArgumentNullException()
        {
            var columnType = Mock.Of<IDbType>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseTableColumn(null, "test_column", columnType, true, null, null));
        }
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseTableColumn(table, null, columnType, true, null, null));
        }
        ...
        {
            var table = Mock.Of<IRelationalDatabaseTable>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseTableColumn(table, "test_column", null, true, null, null));
        }
        ...
        public static void Table_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseTableColumn(tableArg, "test_column", columnType, true, null, null);
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseTableColumn(table, columnName, columnType, true, null, null);
        ...
        public static void IsNullable_GivenFalseCtorArgPropertyGet_EqualsFalse()
        {
            ...
            var table = Mock.Of<IRelationalDatabaseTable>();
            var columnType = Mock.Of<IDbType>();
            var column = new MySqlDatabaseTableColumn(table, columnName, columnType, false, null, null);
        ...
        public static void DefaultValue_PropertyGet_ReturnsCtorArg()
        {
            ...
            var column = new MySqlDatabaseTableColumn(table, columnName, columnType, true, defaultValue, null);
        ...
        public static void AutoIncrement_GivenValidCtorArgPropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseTableColumn(table, columnName, columnType, true, null, autoIncrement);
