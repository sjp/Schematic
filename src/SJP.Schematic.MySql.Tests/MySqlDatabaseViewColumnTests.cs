...
{
    [TestFixture]
    internal static class MySqlDatabaseViewColumnTests
    {
        [Test]
        public static void Ctor_GivenNullView_ThrowsArgumentNullException()
        {
            var columnType = Mock.Of<IDbType>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewColumn(null, "test_column", columnType, true, null, null));
        }
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            var columnType = Mock.Of<IDbType>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewColumn(view, null, columnType, true, null, null));
        }
        ...
        {
            var view = Mock.Of<IRelationalDatabaseView>();
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewColumn(view, "test_column", null, true, null, null));
        }
        ...
        public static void View_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseViewColumn(viewArg, "test_column", columnType, true, null, null);
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseViewColumn(view, columnName, columnType, true, null, null);
        ...
        public static void IsNullable_GivenFalseCtorArgPropertyGet_EqualsFalse()
        {
            ...
            var view = Mock.Of<IRelationalDatabaseView>();
            var columnType = Mock.Of<IDbType>();
            var column = new MySqlDatabaseViewColumn(view, columnName, columnType, false, null, null);
        ...
        public static void DefaultValue_PropertyGet_ReturnsCtorArg()
        {
            ...
            var column = new MySqlDatabaseViewColumn(view, columnName, columnType, true, defaultValue, null);
        ...
        public static void AutoIncrement_GivenValidCtorArgPropertyGet_EqualsCtorArg()
        {
            ...
            var column = new MySqlDatabaseViewColumn(view, columnName, columnType, true, null, autoIncrement);
