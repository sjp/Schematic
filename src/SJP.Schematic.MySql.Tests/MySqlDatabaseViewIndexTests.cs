...
{
    [TestFixture]
    internal static class MyDatabaseViewIndexTests
    {
        [Test]
        public static void Ctor_GivenNullView_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewIndex(null, indexName, isUnique, columns));
        }
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewIndex(view, null, isUnique, columns));
        }
        ...
        public static void Ctor_GivenNullColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewIndex(view, indexName, isUnique, null));
        }
        ...
        public static void Ctor_GivenEmptyColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MySqlDatabaseViewIndex(view, indexName, isUnique, columns));
        }
        ...
        public static void Table_PropertyGet_EqualsCtorArg()
        {
            ...
            var index = new MySqlDatabaseViewIndex(view, indexName, isUnique, columns);
        ...
        public static void IsEnabled_PropertyGet_ReturnsTrue()
        {
            ...
            var index = new MySqlDatabaseViewIndex(table, indexName, isUnique, columns);
