...
internal static class OrmLiteViewGeneratorTests
{
    ...
    {
        Assert.That(
            () => new OrmLiteViewGenerator(null, new VerbatimNameTranslator(), "test"),
    ...
    {
        Assert.That(
            () => new OrmLiteViewGenerator(new MockFileSystem(), null, "test"),
    ...
    public static void Ctor_GivenNullOrWhiteSpaceNamespace_ThrowsArgumentException(string ns)
    {
        ...
        Assert.That(
            () => new OrmLiteViewGenerator(fileSystem, nameTranslator, ns),
