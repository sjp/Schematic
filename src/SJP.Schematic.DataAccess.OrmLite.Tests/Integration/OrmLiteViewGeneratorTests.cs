...
", TestContext.CurrentContext.CancellationToken);
    ...
    teststring text default 'test'
        ...
        await DbConnection.ExecuteAsync("create view test_view_3 as select 1 as test_column_1", TestContext.CurrentContext.CancellationToken);
    }
    ...
    public async Task CleanUp()
    {
        ...
        await DbConnection.ExecuteAsync("drop view test_view_3", TestContext.CurrentContext.CancellationToken);
    }
