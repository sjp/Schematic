...
internal static class OrmLiteTableGeneratorTests
{
    ...
    {
        Assert.That(
            () => new OrmLiteTableGenerator(null, new VerbatimNameTranslator(), "test"),
    ...
    {
        Assert.That(
            () => new OrmLiteTableGenerator(new MockFileSystem(), null, "test"),
    ...
    public static void Ctor_GivenNullOrWhiteSpaceNamespace_ThrowsArgumentException(string ns)
    {
        ...
        Assert.That(
            () => new OrmLiteTableGenerator(fileSystem, nameTranslator, ns),
    ...
    public static void Generate_GivenNullDatabase_ThrowsArgumentNullException()
    {
        ...
        Assert.That(
            () => generator.Generate(null, table, Option<IRelationalDatabaseTableComments>.None),
    ...
    public static void Generate_GivenNullTable_ThrowsArgumentNullException()
    {
        ...
        Assert.That(
            () => generator.Generate([], null, Option<IRelationalDatabaseTableComments>.None),
