...
namespace SJP.Schematic.DataAccess.EntityFrameworkCore.Tests
{
    ...
    internal static class EFCoreDataAccessGeneratorTests
    {
        ...
        public static void Ctor_GivenNullIndent_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new EFCoreDataAccessGenerator(mockFs, database, commentProvider, nameTranslator, null));
        }
        ...
        public static void GenerateAsync_GivenNullProjectPath_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync(null, "test"));
        }
        ...
        public static void GenerateAsync_GivenEmptyProjectPath_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync(string.Empty, "test"));
        }
        ...
        public static void GenerateAsync_GivenWhiteSpaceProjectPath_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync("    ", "test"));
        }
        ...
        public static void GenerateAsync_GivenNullNamespace_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync(projectPath, null));
        }
        ...
        public static void GenerateAsync_GivenEmptyNamespace_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync(projectPath, string.Empty));
        }
        ...
        public static void GenerateAsync_GivenWhiteSpaceNamespace_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => generator.GenerateAsync(projectPath, "    "));
        }
        ...
        public static void GenerateAsync_GivenProjectPathNotACsproj_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => generator.GenerateAsync(projectPath, "test"));
        }
    }
}
