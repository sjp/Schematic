...
internal static class EFCoreDataAccessGeneratorTests
{
    ...
    public static void Ctor_GivenNullFileSystem_ThrowsArgumentNullException()
    {
        ...
        Assert.That(
            () => new EFCoreDataAccessGenerator(null, database, commentProvider, nameTranslator),
    ...
    public static void Ctor_GivenNullDatabase_ThrowsArgumentNullException()
    {
        ...
        var nameTranslator = new VerbatimNameTranslator();
        Assert.That(
            () => new EFCoreDataAccessGenerator(mockFs, null, commentProvider, nameTranslator),
    ...
    public static void Ctor_GivenNullCommentProvider_ThrowsArgumentNullException()
    {
        ...
        var nameTranslator = new VerbatimNameTranslator();
        Assert.That(
            () => new EFCoreDataAccessGenerator(mockFs, database, null, nameTranslator),
    ...
    public static void Ctor_GivenNullNameTranslator_ThrowsArgumentNullException()
    {
        ...
        var commentProvider = new EmptyRelationalDatabaseCommentProvider(IdentifierDefaults);
        Assert.That(
            () => new EFCoreDataAccessGenerator(mockFs, database, commentProvider, null),
    ...
    public static async Task GenerateAsync_WhenInvoked_WritesPackageVersionWithoutBuildMetadata()
    {
        ...
        var version = XDocument.Parse(projectText)
            ...
            .Single(static e => e.Attribute("Include")?.Value == "Microsoft.EntityFrameworkCore.Relational")
