...
public class PrimaryKeyColumnNotFirstColumnRule : Rule, ITableRule
{
    ...
    /// column ordering is a convention, not a defect.
    /// </summary>
    ...
    protected IReadOnlyCollection<IRuleMessage> AnalyseTable(IRelationalDatabaseTable table, IDatabaseKey primaryKey)
    {
        ArgumentNullException.ThrowIfNull(table);
