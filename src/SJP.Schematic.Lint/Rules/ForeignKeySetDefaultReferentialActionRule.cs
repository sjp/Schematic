...
public class ForeignKeySetDefaultReferentialActionRule : Rule, ITableRule
{
    ...
    /// SET DEFAULT silently rewrites data on parent changes.
    /// </summary>
    ...
    protected static string RuleId => "SCHEMATIC0026";

    /// <summary>
    /// Gets the rule title.
    /// </summary>
    /// <value>The rule title.</value>
    protected static string RuleTitle => "Foreign key with a SET DEFAULT action on columns without a default value.";
}
