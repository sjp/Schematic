...
namespace SJP.Schematic.SqlServer.Tests
{
    ...
    internal static class SqlServerExpressionComparerTests
    {
        ...
        public static void Ctor_GivenNullComparer_CreatesWithoutError()
        {
            ...
            Assert.That(() => new SqlServerExpressionComparer(sqlStringComparer: argComparer), Throws.Nothing);
        }
        ...
        {
            var argComparer = StringComparer.Ordinal;
            Assert.That(() => new SqlServerExpressionComparer(argComparer), Throws.Nothing);
        }

        [Test]
        public static void Ctor_GivenNoComparers_CreatesWithoutError()
        {
            Assert.That(() => new SqlServerExpressionComparer(), Throws.Nothing);
        }
