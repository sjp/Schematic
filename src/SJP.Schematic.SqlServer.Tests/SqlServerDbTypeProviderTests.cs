...
internal static class SqlServerDbTypeProviderTests
{
    ...
    {
        var provider = new SqlServerDbTypeProvider();

        var first = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("sys", "nvarchar"), DataType = DataType.Unknown, MaxLength = 100 });
        var second = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("sys", "nvarchar"), DataType = DataType.Unknown, MaxLength = 100 });
    ...
    public static void CreateColumnType_GivenMetadataDifferingInLength_ReturnsDifferentTypes()
    {
        ...
        var shorter = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("sys", "nvarchar"), DataType = DataType.Unknown, MaxLength = 100 });
        var longer = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("sys", "nvarchar"), DataType = DataType.Unknown, MaxLength = 200 });
