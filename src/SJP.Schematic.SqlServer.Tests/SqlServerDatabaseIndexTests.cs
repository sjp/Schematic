...
{
    [TestFixture]
    internal static class SqlServerDatabaseIndexTests
    {
        [Test]
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SqlServerDatabaseIndex(null, isUnique, columns, includedColumns, enabled));
        }
        ...
        public static void Ctor_GivenNullColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SqlServerDatabaseIndex(indexName, isUnique, null, includedColumns, enabled));
        }
        ...
        public static void Ctor_GivenEmptyColumnSet_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SqlServerDatabaseIndex(indexName, isUnique, columns, includedColumns, enabled));
        }
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var index = new SqlServerDatabaseIndex(indexName, isUnique, columns, includedColumns, enabled);
