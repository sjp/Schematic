...
namespace SJP.Schematic.SqlServer.Tests.Integration
{
    internal partial class SqlServerRelationalDatabaseTableTests : SqlServerTest
    {
        ...
        {
            var table = Database.GetTable("trigger_test_table_2").UnwrapSome();
        ...
        {
            var table = Database.GetTable("trigger_test_table_1").UnwrapSome();
            var triggerLookup = table.Trigger;
...
";
        ...
        [Test]
        public void Trigger_GivenTableWithTriggerInsteadOfInsert_ReturnsCorrectEventAndTiming()
        {
            var table = Database.GetTable("trigger_test_table_1").UnwrapSome();
            var triggerLookup = table.Trigger;
            var trigger = triggerLookup["trigger_test_table_1_trigger_7"];
        ...
        [Test]
        public void Trigger_GivenTableWithTriggerInsteadOfUpdate_ReturnsCorrectEventAndTiming()
        {
            var table = Database.GetTable("trigger_test_table_1").UnwrapSome();
            var triggerLookup = table.Trigger;
            var trigger = triggerLookup["trigger_test_table_1_trigger_8"];
        ...
        [Test]
        public void Trigger_GivenTableWithTriggerInsteadOfDelete_ReturnsCorrectEventAndTiming()
        {
            var table = Database.GetTable("trigger_test_table_1").UnwrapSome();
            var triggerLookup = table.Trigger;
            var trigger = triggerLookup["trigger_test_table_1_trigger_9"];
...
";
        ...
        public async Task TriggerAsync_GivenTableWithNoTriggers_ReturnsEmptyLookup()
        {
            ...
            var triggerLookup = await tableOption.UnwrapSome().TriggerAsync().ConfigureAwait(false);
...
";
        ...
        [Test]
        public async Task TriggerAsync_GivenTableWithTriggerInsteadOfInsert_ReturnsCorrectEventAndTiming()
        {
            var tableOption = await Database.GetTableAsync("trigger_test_table_1").ConfigureAwait(false);
            var triggerLookup = await tableOption.UnwrapSome().TriggerAsync().ConfigureAwait(false);
            var trigger = triggerLookup["trigger_test_table_1_trigger_7"];
        ...
        [Test]
        public async Task TriggerAsync_GivenTableWithTriggerInsteadOfUpdate_ReturnsCorrectEventAndTiming()
        {
            var tableOption = await Database.GetTableAsync("trigger_test_table_1").ConfigureAwait(false);
            var triggerLookup = await tableOption.UnwrapSome().TriggerAsync().ConfigureAwait(false);
            var trigger = triggerLookup["trigger_test_table_1_trigger_8"];
        ...
        [Test]
        public async Task TriggerAsync_GivenTableWithTriggerInsteadOfDelete_ReturnsCorrectEventAndTiming()
        {
            var tableOption = await Database.GetTableAsync("trigger_test_table_1").ConfigureAwait(false);
            var triggerLookup = await tableOption.UnwrapSome().TriggerAsync().ConfigureAwait(false);
            var trigger = triggerLookup["trigger_test_table_1_trigger_9"];
