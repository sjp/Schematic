...
internal sealed partial class SqlServerRelationalDatabaseTableProviderTests : SqlServerTest
{
    ...
    [Test]
    public async Task ParentKeys_WhenGivenTableWithForeignKeyToUniqueIndexWithNoBackingConstraint_ContainsConstraintWithCorrectNames()
    {
    ...
    [Test]
    public async Task ParentKeys_WhenGivenTableWithForeignKeyToUniqueIndexWithNoBackingConstraint_ContainsConstraintWithCorrectKeyTypes()
    {
        var table = await GetTableAsync("table_test_table_43");
        var foreignKey = table.ParentKeys.Single();
    ...
    [Test]
    public async Task ParentKeys_WhenGivenTableWithForeignKeyToUniqueIndexWithNoBackingConstraint_ContainsConstraintWithCorrectColumns()
    {
        var table = await GetTableAsync("table_test_table_43");
        var foreignKey = table.ParentKeys.Single();
