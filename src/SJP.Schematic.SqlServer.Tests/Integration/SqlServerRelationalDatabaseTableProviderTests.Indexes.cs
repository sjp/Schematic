...
namespace SJP.Schematic.SqlServer.Tests.Integration
{
    internal partial class SqlServerRelationalDatabaseTableProviderTests : SqlServerTest
    {
        ...
        {
            var table = await TableProvider.GetTableAsync("table_test_table_8").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
        ...
        public async Task IndexesAsync_WhenGivenTableWithMultiColumnIndex_ReturnsIndexWithColumnsInCorrectOrder()
        {
            ...
            var table = await TableProvider.GetTableAsync("table_test_table_9").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
            var index = indexes.Single();
            var indexColumns = index.Columns
                .Select(c => c.DependentColumns.Single())
        ...
        public async Task IndexesAsync_WhenGivenTableWithIndexContainingSingleIncludedColumn_ReturnsIndexWithIncludedColumn()
        {
            ...
            var table = await TableProvider.GetTableAsync("table_test_table_10").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
            var index = indexes.Single();
            var indexColumns = index.Columns
                .Select(c => c.DependentColumns.Single())
        ...
        public async Task IndexesAsync_WhenGivenTableWithIndexContainingMultipleIncludedColumns_ReturnsIndexWithAllColumnsInCorrectOrder()
        {
            ...
            var table = await TableProvider.GetTableAsync("table_test_table_11").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
            var index = indexes.Single();
            var indexColumns = index.Columns
                .Select(c => c.DependentColumns.Single())
        ...
        {
            var table = await TableProvider.GetTableAsync("table_test_table_12").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
            var index = indexes.Single();
        ...
        {
            var table = await TableProvider.GetTableAsync("table_test_table_13").UnwrapSomeAsync().ConfigureAwait(false);
            var indexes = await table.IndexesAsync().ConfigureAwait(false);
            var index = indexes.Single();
