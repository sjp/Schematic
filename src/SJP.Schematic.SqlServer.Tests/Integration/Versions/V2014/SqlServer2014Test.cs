...
namespace SJP.Schematic.SqlServer.Tests.Integration.Versions.V2014
{
    internal static class Config2014
    {
        ...
        private static IConfigurationRoot Configuration => new ConfigurationBuilder()
            .AddJsonFile("sqlserver-test-2014.json.config")
            .AddJsonFile("sqlserver-test-2014.json.config.local", optional: true)
            .Build();
    }
    ...
    internal abstract class SqlServer2014Test
    {
        ...
        protected IDatabaseDialect Dialect { get; } = new SqlServerDialect(Config2014.Connection);
