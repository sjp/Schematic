...
{
    [TestFixture]
    internal static class SqlServerDatabaseColumnTests
    {
        [Test]
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            var columnType = Mock.Of<IDbType>();
            Assert.Throws<ArgumentNullException>(() => new SqlServerDatabaseColumn(null, columnType, true, null, null));
        }

        [Test]
        public static void Ctor_GivenNullType_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new SqlServerDatabaseColumn("test_column", null, true, null, null));
        }
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var column = new SqlServerDatabaseColumn(columnName, columnType, true, null, null);
        ...
        public static void IsNullable_GivenFalseCtorArgPropertyGet_EqualsFalse()
        {
            Identifier columnName = "test_column";
            var columnType = Mock.Of<IDbType>();
            var column = new SqlServerDatabaseColumn(columnName, columnType, false, null, null);
        ...
        public static void DefaultValue_PropertyGet_ReturnsCtorArg()
        {
            ...
            var column = new SqlServerDatabaseColumn(columnName, columnType, true, defaultValue, null);
        ...
        public static void AutoIncrement_GivenValidCtorArgPropertyGet_EqualsCtorArg()
        {
            ...
            var column = new SqlServerDatabaseColumn(columnName, columnType, true, null, autoIncrement);
