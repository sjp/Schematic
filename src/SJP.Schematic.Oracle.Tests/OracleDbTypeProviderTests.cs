...
internal static class OracleDbTypeProviderTests
{
    ...
    {
        var provider = new OracleDbTypeProvider();

        var first = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("SYS", "VARCHAR2"), DataType = DataType.Unknown, MaxLength = 100 });
        var second = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("SYS", "VARCHAR2"), DataType = DataType.Unknown, MaxLength = 100 });
    ...
    public static void CreateColumnType_GivenMetadataDifferingInLength_ReturnsDifferentTypes()
    {
        ...
        var shorter = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("SYS", "VARCHAR2"), DataType = DataType.Unknown, MaxLength = 100 });
        var longer = provider.CreateColumnType(new ColumnTypeMetadata { TypeName = new Identifier("SYS", "VARCHAR2"), DataType = DataType.Unknown, MaxLength = 200 });
