...
internal static class OracleDatabaseQueryViewProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseQueryViewProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseQueryViewProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseQueryViewProvider(connection, identifierDefaults, null),
