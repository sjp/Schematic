...
internal static class OracleQueryViewCommentProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleQueryViewCommentProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleQueryViewCommentProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleQueryViewCommentProvider(connection, identifierDefaults, null),
