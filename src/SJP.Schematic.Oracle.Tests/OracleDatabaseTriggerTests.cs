...
namespace SJP.Schematic.Oracle.Tests
{
    ...
    internal static class OracleDatabaseTriggerTests
    {
        ...
        public static void Ctor_GivenNullName_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new OracleDatabaseTrigger(null, definition, timing, events, enabled));
        }
        ...
        public static void Ctor_GivenNullDefinition_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new OracleDatabaseTrigger(triggerName, null, timing, events, enabled));
        }
        ...
        public static void Ctor_GivenEmptyDefinition_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new OracleDatabaseTrigger(triggerName, definition, timing, events, enabled));
        }
        ...
        public static void Ctor_GivenInvalidTriggerQueryTiming_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => new OracleDatabaseTrigger(triggerName, definition, timing, events, enabled));
        }
        ...
        public static void Name_PropertyGet_EqualsCtorArg()
        {
            ...
            var trigger = new OracleDatabaseTrigger(triggerName, definition, timing, events, enabled);
