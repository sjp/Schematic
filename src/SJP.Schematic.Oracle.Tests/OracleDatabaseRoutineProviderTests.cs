...
internal static class OracleDatabaseRoutineProviderTests
{
    ...
    public static void Ctor_GivenNullConnection_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseRoutineProvider(null, identifierDefaults, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierDefaults_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseRoutineProvider(connection, null, identifierResolver),
    ...
    public static void Ctor_GivenNullIdentifierResolver_ThrowsArgNullException()
    {
        ...
        Assert.That(
            () => new OracleDatabaseRoutineProvider(connection, identifierDefaults, null),
