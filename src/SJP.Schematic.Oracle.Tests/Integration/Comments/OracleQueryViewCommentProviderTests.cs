...
internal sealed class OracleQueryViewCommentProviderTests : OracleTest
{
    ...
    {
        await DbConnection.ExecuteAsync("create table view_comment_table_1 ( test_column_1 number, test_column_2 number, test_column_3 number )", TestContext.CurrentContext.CancellationToken);
        ...
        await DbConnection.ExecuteAsync("comment on table view_comment_view_2 is 'This is a test view comment.'", TestContext.CurrentContext.CancellationToken);
        await DbConnection.ExecuteAsync("comment on column view_comment_view_2.test_column_2 is 'This is a column comment.'", TestContext.CurrentContext.CancellationToken);
    }
