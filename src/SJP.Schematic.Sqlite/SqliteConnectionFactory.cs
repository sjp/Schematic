...
public class SqliteConnectionFactory : IDbConnectionFactory
{
    ...
    /// An optional callback used to configure each <see cref="SqliteConnection"/> before it is opened.
    ...
    protected Action<SqliteConnection>? ConnectionConfiguration { get; }
