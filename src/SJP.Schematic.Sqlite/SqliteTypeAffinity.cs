...
/// </summary>
/// <remarks>There are five possible types of data storage: <see langword="null" />, <c>INTEGER</c>, <c>REAL</c>, <c>TEXT</c>, <c>BLOB</c>.</remarks>
public enum SqliteTypeAffinity
{
    ...
    /// <summary>
    /// A type affinity that stores all data using storage classes <see langword="null" />, <c>TEXT</c> or <c>BLOB</c>.
    /// </summary>
    Text,
