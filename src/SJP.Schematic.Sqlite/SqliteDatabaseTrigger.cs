...
/// <summary>
/// A SQLite database trigger definition.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SqliteDatabaseTrigger"/> class.
    /// </summary>
    ...
    public SqliteDatabaseTrigger(Identifier name, string definition, TriggerQueryTiming queryTiming, TriggerEvent events)
        : this(name, definition, queryTiming, events, Option<string>.None, [])
    {
    }
    ...
    /// </summary>
    /// <value>Always <see cref="TriggerGranularity.Row"/>, as SQLite only supports row-level triggers.</value>
