...
namespace SJP.Schematic.Sqlite.Pragma
{
    public class ConnectionPragma : ISqliteConnectionPragma
    {
        ...
        public Task<bool> LegacyFileFormatAsync(CancellationToken cancellationToken = default) => DbConnection.ExecuteScalarAsync<bool>(LegacyFileFormatReadQuery, cancellationToken);

        public Task LegacyFileFormatAsync(bool enable, CancellationToken cancellationToken = default) => DbConnection.ExecuteAsync(LegacyFileFormatSetQuery(enable), cancellationToken);
