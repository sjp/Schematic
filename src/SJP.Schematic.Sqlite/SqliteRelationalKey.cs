...
namespace SJP.Schematic.Sqlite
{
    ...
    {
        public SqliteRelationalKey(Identifier childTableName, IDatabaseKey childKey, Identifier parentTableName, IDatabaseKey parentKey, Rule deleteRule, Rule updateRule)
        {
