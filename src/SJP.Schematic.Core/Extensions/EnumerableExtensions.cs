...
public static class EnumerableExtensions
{
    ...
    /// <returns><see langword="true" /> if the collection is <see langword="null" /> or has no elements; otherwise <see langword="false" />.</returns>
    ...
    /// <summary>
    /// Determines whether a collection is <see langword="null" /> or has elements which are <see langword="null" />.
    /// </summary>
    /// <typeparam name="T">The type of objects to enumerate.</typeparam>
    /// <param name="source">The source collection.</param>
    ...
    /// <summary>
    /// Determines whether a collection has elements which are <see langword="null" />.
    /// </summary>
    /// <typeparam name="T">The type of objects to enumerate.</typeparam>
    /// <param name="source">The source collection.</param>
    /// <returns><see langword="true" /> if the collection has elements which are <see langword="null" />; otherwise <see langword="false" />.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null" />.</exception>
    ...
    /// <param name="source">The source collection.</param>
    /// <param name="keySelector">The selector which returns a key used for uniqueness testing.</param>
    /// <param name="comparer">A comparer used for uniqueness testing. Defaults to <see cref="EqualityComparer{TKey}.Default"/> when <see langword="null" />.</param>
    /// <returns>A <see cref="IReadOnlyDictionary{TKey, TValue}"/> whose keys are the group keys, and values are members of the given group.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="keySelector"/> is <see langword="null" />.</exception>
