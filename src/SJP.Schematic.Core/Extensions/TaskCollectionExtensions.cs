...
/// <summary>
/// Convenience extension methods for working with tuples of <see cref="Task{TResult}"/> objects.
/// </summary>
public static class TaskCollectionExtensions
{
    /// <summary>
    /// Creates a task that will complete when all of the provided <see cref="Task{TResult}"/> objects have completed.
    ...
    /// <param name="tasks">A tuple of <see cref="Task{TResult}"/> objects.</param>
    /// <returns>A tuple containing the resulting values from all of the completed <see cref="Task{TResult}"/> operations.</returns>
