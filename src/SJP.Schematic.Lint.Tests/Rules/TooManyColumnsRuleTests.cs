...
internal static class TooManyColumnsRuleTests
{
    ...
    public static void Ctor_GivenInvalidLevel_ThrowsArgumentException()
    {
        ...
        Assert.That(() => new TooManyColumnsRule(level), Throws.ArgumentException.With.Property(nameof(ArgumentException.ParamName)).EqualTo("level"));
    }

    [Test]
    public static void Ctor_GivenZeroColumnLimit_ThrowsArgumentOutOfRangeException()
    {
        Assert.That(() => new TooManyColumnsRule(RuleLevel.Error, 0), Throws.TypeOf<ArgumentOutOfRangeException>().With.Property(nameof(ArgumentException.ParamName)).EqualTo("columnLimit"));
    }
