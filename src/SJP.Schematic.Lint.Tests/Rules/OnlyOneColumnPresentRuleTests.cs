...
namespace SJP.Schematic.Lint.Tests.Rules
{
    ...
    internal static class OnlyOneColumnPresentRuleTests
    {
        ...
        [Test]
        public static void AnalyseTables_GivenTableWithOneColumn_ProducesMessages()
        {
            var rule = new OnlyOneColumnPresentRule(RuleLevel.Error);
        ...
        [Test]
        public static async Task AnalyseTablesAsync_GivenTableWithOneColumn_ProducesMessages()
        {
            var rule = new OnlyOneColumnPresentRule(RuleLevel.Error);
