...
namespace SJP.Schematic.PostgreSql
{
    ...
    {
        public PostgreSqlRelationalKey(Identifier childTableName, IDatabaseKey childKey, Identifier parentTableName, IDatabaseKey parentKey, Rule deleteRule, Rule updateRule)
        {
