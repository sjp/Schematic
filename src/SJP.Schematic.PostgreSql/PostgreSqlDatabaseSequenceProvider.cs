...
namespace SJP.Schematic.PostgreSql
{
    ...
    {
        public PostgreSqlDatabaseSequenceProvider(IDbConnection connection, IDatabaseIdentifierDefaults identifierDefaults, IIdentifierResolutionStrategy identifierResolver)
        {
