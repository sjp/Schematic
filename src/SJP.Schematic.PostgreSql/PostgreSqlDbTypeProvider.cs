...
public class PostgreSqlDbTypeProvider : IDbTypeProvider
{
    ...
    private static readonly IEnumerable<Identifier> TypeNamesWithNoLengthAnnotation = new HashSet<Identifier>(IdentifierComparer.Ordinal)
    {
        ...
        new("pg_catalog", "int8"),
        new("pg_catalog", "bigserial"),
        new("pg_catalog", "serial8"),
        new("pg_catalog", "boolean"),
        new("pg_catalog", "bool"),
        new("pg_catalog", "box"),
        new("pg_catalog", "bytea"),
        new("pg_catalog", "cidr"),
        new("pg_catalog", "circle"),
        new("pg_catalog", "date"),
        new("pg_catalog", "float8"),
        new("pg_catalog", "inet"),
        new("pg_catalog", "integer"),
        new("pg_catalog", "int"),
        new("pg_catalog", "int4"),
        new("pg_catalog", "json"),
        new("pg_catalog", "jsonb"),
        new("pg_catalog", "line"),
        new("pg_catalog", "lseg"),
        ...
        new("pg_catalog", "real"),
        new("pg_catalog", "float4"),
        new("pg_catalog", "smallint"),
        new("pg_catalog", "int2"),
        new("pg_catalog", "smallserial"),
        new("pg_catalog", "serial2"),
        new("pg_catalog", "serial"),
        new("pg_catalog", "serial4"),
        new("pg_catalog", "text"),
        new("pg_catalog", "tsquery"),
    ...
    private static readonly IReadOnlyDictionary<Identifier, DataType> StringToDataTypeMap = new Dictionary<Identifier, DataType>(IdentifierComparer.Ordinal)
    {
        ...
        [new Identifier("pg_catalog", "json")] = DataType.Json,
        [new Identifier("pg_catalog", "jsonb")] = DataType.Json,
