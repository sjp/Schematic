...
/// <summary>
/// Helpers for lexing PostgreSQL text into ANTLR tokens.
/// </summary>
internal static class PostgreSqlLexing
{
    /// <summary>
    ...
    /// <exception cref="PostgreSqlSyntaxErrorException">The SQL could not be lexed.</exception>
